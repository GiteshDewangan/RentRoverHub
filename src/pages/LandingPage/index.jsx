                ...
                <div className="bg-white-A700 flex flex-col items-start justify-start p-6 sm:px-5 rounded-[16px] w-full">
                  <div className="flex flex-col gap-[38px] items-center justify-start w-full">
                    <div className="flex sm:flex-col flex-row gap-4 items-center justify-center w-full">
                      ...
                      <Button onClick={()=>setoption('buy')}  className={option=='buy'?"bg-gray-900 cursor-pointer flex-1 font-bold py-3 rounded-[10px] text-center text-lg text-white-A700 w-full":'bg-gray-300 cursor-pointer flex-1 font-bold py-3 rounded-[10px] text-center text-lg text-black-lg w-full'}>
                        Buy
                        
                      </Button>
        
                      <Button onClick={()=>setoption('sell')} className={option=='sell'?"bg-gray-900 cursor-pointer flex-1 font-bold py-3 rounded-[10px] text-center text-lg text-white-A700 w-full":'bg-gray-300 cursor-pointer flex-1 font-bold py-3 rounded-[10px] text-center text-lg text-black-lg w-full'}>
                        Sell
                      </Button>
                      <Button onClick={()=>setoption('rent')} className={option=='rent'?"bg-gray-900 cursor-pointer flex-1 font-bold py-3 rounded-[10px] text-center text-lg text-white-A700 w-full":'bg-gray-300 cursor-pointer flex-1 font-bold py-3 rounded-[10px] text-center text-lg text-black-lg w-full'}>
                        Rent
                      </Button>
                    ...
                    <div className="flex flex-col gap-6 items-start justify-start w-full">
                      ...
                      {M(option)}
                      <Button onClick={()=>navigate('/login')} className="bg-gray-900 cursor-pointer font-bold py-[17px] rounded-[10px] text-center text-lg text-white-A700 w-full">
                        Search
                      </Button>
                    </div>
                  </div>
                ...
                <React.Fragment key={Math.random()}>
                  <div className="flex md:flex-col flex-row md:gap-10 gap-[100px] items-start justify-start mx-2.5">
                    <Img
                      ...
                      src="https://img.freepik.com/premium-photo/happy-indian-business-man-leader-manager-standing-office-headshot-portrait_562687-3375.jpg"
                      alt="rectangle5591"
                    />
                    <div className="flex flex-1 flex-col items-start justify-start w-full">
