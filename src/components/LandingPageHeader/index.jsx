        ...
        <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
          <div className="header-row my-px">
            <div className="flex flex-row gap-[11px] items-center justify-start">
              ...
              https://media.istockphoto.com/id/1211788306/photo/simple-white-house-icon-3d-rendering.webp?s=1024x1024&w=is&k=20&c=p6ATwfbKtz4EEuonXHAlCgnZbHEvOsU4ucKtOqJVGvw=" alt="home" />
              <Text
          ...
          <div className="flex sm:flex-1 sm:flex-col flex-row sm:hidden items-center justify-between w-[492px] sm:w-full">
            ...
            >
              ...
              <div className="flex flex-row gap-1.5 items-start justify-start w-[77px]">
                <Text
                  ...
                  size="txtManropeSemiBold16"
                >
                  <NavLink to='/agentlist'>Agents</NavLink>
                </Text>
            ...
            <Text
              ...
              size="txtManropeSemiBold16"
            >
            <NavLink to='/propertydetails'>property</NavLink>
            </Text>
            <Text
              className="text-base text-gray-900 w-auto"
              size="txtManropeSemiBold16"
            >
              <NavLink to='/blogdetails'>Blogs</NavLink>
            </Text>
            <Text
              className="text-base text-gray-900 w-auto"
              size="txtManropeSemiBold16"
          ...
          <div className="flex flex-row gap-10 h-[42px] md:h-auto sm:hidden items-center justify-start w-[228px]">
            <input type="text" placeholder="Search" style={{width:"100px",borderRadius:"10px"}}/>
            <Button onClick={()=>nav('/login')} className="bg-gray-900 cursor-pointer font-manrope font-semibold py-2.5 rounded-[10px] text-base text-center text-white-A700 w-full">
              Log in
            </Button>
          </div>
        </div>
